      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-1 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-sm text-white text-center lg:text-left text-justify">
              Explore workout routines, nutrition tips, fitness challenges, and
              wellness advice to achieve your health goals and stay motivated.
            </p>
          </div>
          <dl className="grid grid-cols-1 sm:grid-cols-3 gap-x-14 gap-y-4">
            <div className="flex flex-col items-start">
              <dd className="mt-2 leading-7 text-gray-400 hover:text-white cursor-pointer">
                About Us
              </dd>
              <dd className="mt-2 leading-7 text-gray-400 hover:text-white cursor-pointer">
                Workouts
