        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-1 lg:max-w-none lg:grid-cols-2">
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 leading-7 text-gray-400">About</dd>
              <dd className="mt-2 leading-7 text-gray-400">Blog</dd>
              <dd className="mt-2 leading-7 text-gray-400">Press</dd>
            </div>
            <div className="flex flex-col items-start">
              <dt className="mt-4 font-semibold text-white">Legal</dt>
              <dd className="mt-2 leading-7 text-gray-400">Claim</dd>
              <dd className="mt-2 leading-7 text-gray-400">Privacy</dd>
              <dd className="mt-2 leading-7 text-gray-400">Terms</dd>
            </div>
          </dl>
        </div>
      </div>
